...
const int MAXKENNTEXTSIZE = 200;           // Philippe 01.02.2016 // Michael inacceptable
...
class Werte {
 ...
 public:
  ...
  double delay_gc;
   ...
   short mode_of_apoptosis, mode_of_setting_TC_time, tc_search_duration_mode;
   ...
   bool stopFoxOonTFH;
   double dT_FoxO, dT_FoxO_min, dT_FoxO_max, dT_FoxO_K, dT_FoxO_n,
     dT_mTORC1, nFoxO, KFoxO;
   ...
   // OUT:
   // ===============
   double mk_ab,pm_differentiation_time,pm_apoptosis_time;
