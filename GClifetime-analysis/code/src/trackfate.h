...
class fateTRACK {
 public:
  ...
  void mk_new_fate_track(hstat &hs);
  void clear_fate_track(hstat &hs);
  void show_track(hstat &hs);
 ...
 private:
  ...
  static int TRACKDIM;
  // absolute cell index
  //static long abs_cell_index[1000];
  //static long abs_track_index[1000];
