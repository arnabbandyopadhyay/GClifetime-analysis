...
class cell {
  ...
  protected:
   ...
   void set_north_polarity(space &l);
...
public:
   ...
   //static double frac_average[max_gc]; // alpha_mean averaged over all cells
   double alpha_mean;
    ...
    * n_move_forbidden_back,n_move_self_back; // these vars are in hstat class
    */
   // delete up to here.
  ...
  private:
   ...
   void set_forbidden_counts(const long &j, double * target, double * old, space &l, hstat &hs);
