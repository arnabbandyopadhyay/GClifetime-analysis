...
void brainbow::save_to_file() {
    ...
    */
   ofstream fff(hyphasma2::prefix_files("brainbow.out"));
...
void brainbow::make_brainbow(double * evaluation_times, int Nevaluations) {
   ...
   ofstream fff(hyphasma2::prefix_files(clonality_file));
   ...
   ofstream lll(hyphasma2::prefix_files(lineage_clonality_file));
   ...
   ofstream colf(hyphasma2::prefix_files(colour_fractions_file));
   ...
   ofstream cf(hyphasma2::prefix_files(clone_fractions_file));
   put_fraction_header(cf);
   ofstream lf(hyphasma2::prefix_files(lineage_fractions_file));
   ...
   ofstream cfr(hyphasma2::prefix_files(clone_fractions_rand_file));
   put_fraction_header(cfr);
   ofstream lfr(hyphasma2::prefix_files(clone_lineage_fractions_rand_file));
